...
public class BeanMapperParserTest extends AndroidTestCase {
	...
	public void testBeanMapperParser() throws IOException {
		...
		/**
		 * <bean name="bean0" class="com.socialize.android.ioc.sample.TestClassWithInitMethod"/>
		 */
		BeanRef beanRef = mapping.getBeanRef("bean0");
		assertNotNull(beanRef);
		assertEquals("com.socialize.android.ioc.sample.TestClassWithInitMethod", beanRef.getClassName());
		
		
		/**
		 * <bean name="bean1" class="com.socialize.android.ioc.sample.TestClassWithIntConstructorArg">
		...
		assertNotNull(beanRef);
		assertEquals("com.socialize.android.ioc.sample.TestClassWithIntConstructorArg", beanRef.getClassName());
		...
		/**
		 * <bean name="bean2" class="com.socialize.android.ioc.sample.SubClassOfTestClassWithInitMethod">
				<constructor-arg value="foobar" type="string"/>
			</bean>
		 */
		beanRef = mapping.getBeanRef("bean2");
		assertNotNull(beanRef);
		assertEquals("com.socialize.android.ioc.sample.SubClassOfTestClassWithInitMethod", beanRef.getClassName());
		assertNotNull(beanRef.getConstructorArgs());
		assertEquals(1, beanRef.getConstructorArgs().size());
		assertNotNull(beanRef.getConstructorArgs().get(0));
		...
		/**
		 * 	<bean name="bean3" class="com.socialize.android.ioc.sample.SubClassOfTestClassWithInitMethod">
		...
		/**
		 * 	<bean name="bean4" class="com.socialize.android.ioc.sample.TestClassWithBeanConstructorArg">
				<constructor-arg value="bean2" type="bean"/>
			</bean>
		 */
		beanRef = mapping.getBeanRef("bean4");
		assertNotNull(beanRef);
		assertEquals("com.socialize.android.ioc.sample.TestClassWithBeanConstructorArg", beanRef.getClassName());
		assertNotNull(beanRef.getConstructorArgs());
		assertEquals(1, beanRef.getConstructorArgs().size());
		assertNotNull(beanRef.getConstructorArgs().get(0));
		...
		/**
		 * 	<bean name="bean5" class="com.socialize.android.ioc.sample.TestClassWithContextConstuctorArg">
				<constructor-arg type="context"/>
			</bean>
		 */
		beanRef = mapping.getBeanRef("bean5");
		assertNotNull(beanRef);
		assertEquals("com.socialize.android.ioc.sample.TestClassWithContextConstuctorArg", beanRef.getClassName());
		assertNotNull(beanRef.getConstructorArgs());
		assertEquals(1, beanRef.getConstructorArgs().size());
		assertNotNull(beanRef.getConstructorArgs().get(0));
		...
		/**
		 * 	<bean name="bean6" class="com.socialize.android.ioc.sample.TestClassWithContextConstuctorArg">
		...
		/**
			<bean name="bean7" class="com.socialize.android.ioc.sample.TestClassWithMultipleProperties">
		...
		assertNotNull(beanRef);
		assertEquals("com.socialize.android.ioc.sample.TestClassWithMultipleProperties", beanRef.getClassName());
		assertNotNull(beanRef.getProperties());
